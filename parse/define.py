...
class Definition:
    ...
    def display_raw(self):
        ...
        print(f"[*] runmode       :  {self.raw_args.runmode}       ")
        print(f"[*] wordlist      :  {self.raw_args.wordlist}      ")
        print(f"[*] extension     :  {self.raw_args.extension}     ")
        ...
        print(f"[*] ssl_no_verify :  {self.raw_args.ssl_no_verify} ")
